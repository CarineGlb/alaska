...
<div class="container-fluid display-table">
    <div class="row display-table-row">
        <div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" id="navigation">
            ...
            <div class="navi">
                <ul>
                    <li class="active"><a href=<?php echo HOST;?>/blog_alaska/index.php?action=tableauBordAdmin><i class="fas fa-home" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Accueil</a> </li>
